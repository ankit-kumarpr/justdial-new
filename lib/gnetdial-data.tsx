...
import { SearchVisibilityIcon, GuaranteedLeadsIcon, OnlineCatalogueIcon, PaymentSolutionsIcon, SmartLeadSystemIcon, CompetitorAnalysisIcon, PremiumCustomerSupportIcon, TrustStampIcon, VerifiedSealIcon, JdRatingCertificateIcon, BusinessWebsiteIcon, WebsiteBannerIcon, MobileBannerIcon } from '@/components/icons/AdvertiseIcons';
...
export const features = [
    ...
    { 
        icon: <JdRatingCertificateIcon />,
        title: 'JD Rating Certificate',
