...
import { Heart, Stethoscope, Activity, Phone, MapPin, Clock, Award } from 'lucide-react';
import Image from 'next/image';

const hospitalServices = [
  { name: 'Emergency Care', icon: Activity, color: 'text-red-500' },
  { name: 'General Medicine', icon: Stethoscope, color: 'text-blue-500' },
  { name: 'Cardiology', icon: Heart, color: 'text-pink-500' },
  { name: 'Orthopedics', icon: Award, color: 'text-green-500' },
];
  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-5xl font-bold text-gray-800">Healthcare Services</h1>
            </div>
            <p className="text-xl text-gray-600 mb-8">Find trusted hospitals and healthcare services near you</p>
      ...
      <main className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Featured Hospitals</h2>
