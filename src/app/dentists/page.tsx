...
import { Smile, Award, Clock, MapPin, Phone, Star, Shield } from 'lucide-react';

const services = [
  { name: 'Teeth Cleaning', icon: Smile, color: 'text-blue-500' },
  { name: 'Root Canal', icon: Shield, color: 'text-red-500' },
  { name: 'Teeth Whitening', icon: Star, color: 'text-yellow-500' },
  { name: 'Dental Implants', icon: Award, color: 'text-green-500' },
];

const topDentists = [
  {
    name: 'Dr. Sharma Dental Clinic',
    specialist: 'Orthodontics & Cosmetic Dentistry',
  ...
  },
  {
    ...
    specialist: 'General & Pediatric Dentistry',
  ...
  },
  {
    ...
    specialist: 'Implants & Root Canal',
    ...
    >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-5xl font-bold text-gray-800">Dentists Near You</h1>
            </div>
            <p className="text-xl text-gray-600 mb-8">Find the best dental care and oral health services</p>
              ...
              <Card className="bg-white/80 backdrop-blur-sm shadow-xl">
                <CardContent className="p-6">
                  <div className="flex gap-3">
                    <input
                      type="text"
                      placeholder="Search for dentists or dental services..."
      ...
      <main className="container mx-auto px-4 py-12 relative z-10">
        ...
        <motion.section
          ...
          className="mb-12"
        >
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Popular Dental Services</h2>
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Top Rated Dentists</h2>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-xl font-bold text-gray-800">{dentist.name}</h3>
                          <div className="flex items-center gap-1 bg-yellow-100 px-2 py-1 rounded">
                            <Star className="h-4 w-4 text-yellow-600 fill-yellow-600" />
                            <span className="text-sm font-semibold text-yellow-700">{dentist.rating}</span>
                          </div>
                        </div>
                        <p className="text-sm text-accent font-medium mb-2">{dentist.specialist}</p>
                        <div className="flex items-center gap-4 text-sm text-gray-600 mb-3">
                          <div className="flex items-center gap-1">
                            <MapPin className="h-4 w-4 text-primary" />
                            <span>{dentist.location}</span>
                          </div>
                          <span className="bg-primary/10 text-primary px-3 py-1 rounded-full font-medium">{dentist.experience}</span>
                        </div>
        ...
        >
          <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-0 shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Maintain Your Dental Health</h3>
              <p className="text-gray-600 mb-4">Regular dental checkups are essential for healthy teeth and gums</p>
