...
const infoItems = [
    { icon: <AwardsIcon />, label: "Awards", href: "/business-dashboard/awards" },
    { icon: <CertificatesIcon />, label: "Certificates", href: "/business-dashboard/certificates" },
    { icon: <ProfessionalAssociationsIcon />, label: "Professional Associations", href: "/business-dashboard/professional-associations" },
];
